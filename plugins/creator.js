...
if (command == 'owner') {
 let vcard = `BEGIN:VCARD\nVERSION:3.0\nN:WhatsApp;Saya Owner 𝙍𝙪𝙠𝙭𝙭𝙭;Bot;;Md\nFN:Saya Owner 𝙍𝙪𝙠𝙭𝙭𝙭 Bot WhatsApp, Md\nNICKNAME:👑 Owner 𝙕𝙚𝙣𝙯 𝘽𝙤𝙩𝙯 bot\nORG:Wudy\nTITLE:soft\nitem1.TEL;waid=6285807264974:+62 858-0726-4974\nitem1.X-ABLabel:📞 Nomor Owner\nitem2.URL:https://s.id/Cerdasin62\nitem2.X-ABLabel:💬 More\nitem3.EMAIL;type=INTERNET:faruqofc@mail.com\nitem3.X-ABLabel:💌 Mail Owner 𝙕𝙚𝙣𝙯 𝘽𝙤𝙩𝙯\nitem4.ADR:;;🇮🇩 Indonesia;;;;\nitem4.X-ABADR:💬 More\nitem4.X-ABLabel:📍 Lokasi Saya\nBDAY;value=date:🔖 13 January 2001\nEND:VCARD`
...
if (command == 'creator') {
  ...
  const sentMsg = await conn.sendContactArray(m.chat, [
    [`${nomorown}`, `${await conn.getName(nomorown+'@s.whatsapp.net')}`, `👑 Developer Bot `, `🚫 Don't call me 🥺`, `faruqofc@gmail.com`, `🇮🇩 Indonesia`, `🚀 https://MaxxyBotz.github.io/`, `👤 Gada pawang nih senggol dong 😔`],
